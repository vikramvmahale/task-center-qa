...
export interface AccpEnvironment {
    ...
    mailTrapInboxId: string; // MailTrap inbox ID for acceptance environment
}
...
export const accpEnvironment: AccpEnvironment = {
    ...
    tokenUrl: '', // Update with ACCP token URL if different
    clientId: '', // Update with ACCP client ID if different
    clientSecret: '', // Update with ACCP client secret if different
    // MailTrap Configuration
    mailTrapApiUrl: 'https://mailtrap.io/api',
    mailTrapAccountId: '849678',
    mailTrapAuthToken: '94ddd2f5aab072292d1b5aea0e4b2e71',
    mailTrapInboxId: '1227273'
};
